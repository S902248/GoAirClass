const BannerManagementView = () => {
  return (
    <div className="animate-in fade-in duration-500">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">B a n n e r M a n a g e m e n t V i e w</h1>
        <p className="text-slate-500 text-sm">Manage and view details for B a n n e r M a n a g e m e n t V i e w.</p>
      </div>
      ...
      <div className="card p-6">
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-lg font-semibold">B a n n e r M a n a g e m e n t V i e w Page</h2>
