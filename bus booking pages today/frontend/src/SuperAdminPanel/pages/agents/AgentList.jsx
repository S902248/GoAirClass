const AgentList = () => {
  return (
    <div className="animate-in fade-in duration-500">
      <div className="mb-6">
        <h1 className="text-2xl font-bold">A g e n t L i s t</h1>
        <p className="text-slate-500 text-sm">Manage and view details for A g e n t L i s t.</p>
      </div>
      ...
      <div className="card p-6">
        <div className="flex flex-col items-center justify-center py-20 text-center">
          ...
          <h2 className="text-lg font-semibold">A g e n t L i s t Page</h2>
