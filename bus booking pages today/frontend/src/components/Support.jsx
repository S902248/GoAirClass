            ...
            <div className="relative z-10 w-full max-w-5xl px-6 flex flex-col items-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 w-full mb-16 animate-in fade-in zoom-in-95 duration-700 delay-200">
                    {contactMethods.map((method, idx) => {
                        ...
                        return (
                            <div key={idx} className="bg-white rounded-[20px] p-8 border border-slate-100 shadow-[0_10px_30px_-15px_rgba(0,0,0,0.05)] hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300 flex flex-col items-center text-center cursor-pointer group">
                                <div className={`${method.bg} ${method.color} w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 group-hover:-rotate-3 transition-transform duration-300`}>
