            ...
            <div className="max-w-4xl mx-auto px-8">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        {/* Trust markers */}
                        <div className="bg-white rounded-[16px] p-12 text-center relative overflow-hidden">
                            ...
                            <div className="flex flex-col items-center gap-4 relative z-10">
                                ...
                                <div>
                                    <h4 className="text-xl font-black text-deep-navy uppercase tracking-widest">Safe & Secure Payments</h4>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest mt-2">All transactions are secured with military-grade 256-bit encryption.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        {/* Fare Summary */}
                        <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100">
                            <h3 className="text-xl font-black text-deep-navy tracking-tight mb-8">Final Summary</h3>
                            <div className="space-y-4">
                                <div className="flex justify-between items-end">
                                    <div>
                                        <div className="text-[10px] font-black text-gray-400 uppercase tracking-widest mb-1">Total to Pay</div>
