...
const TrainHero = ({ setView }) => {
    const [date, setDate] = useState('25-02-2026');
                        ...
                        <div className="flex lg:w-[45%] relative bg-transparent">
                            ...
                            <div className="flex-1 flex items-center px-6 py-5 cursor-pointer hover:bg-slate-50/80 transition-colors group">
                                ...
                                <div className="flex flex-col flex-1">
                                    ...
                                    <input type="text" className="bg-transparent border-none outline-none text-base font-bold text-slate-800 w-full placeholder:text-slate-300" placeholder="Departure Station" defaultValue="New Delhi (NDLS)" />
                                </div>
                            </div>

                            {/* Swap Button */}
                            <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
                                <button className="bg-white border border-slate-200 rounded-full p-2.5 cursor-pointer hover:border-[#f26a36] hover:text-[#f26a36] transition-all shadow-lg hover:shadow-[#f26a36]/20 active:scale-95 text-slate-400">
                            ...
                            <div className="flex-1 flex items-center px-6 py-5 cursor-pointer hover:bg-slate-50/80 transition-colors group pl-8">
                                ...
                                <div className="flex flex-col flex-1">
                                    ...
                                    <input type="text" className="bg-transparent border-none outline-none text-base font-bold text-slate-800 w-full placeholder:text-slate-300" placeholder="Arrival Station" defaultValue="Mumbai Central (MMCT)" />
                                </div>
                            </div>
                        </div>
